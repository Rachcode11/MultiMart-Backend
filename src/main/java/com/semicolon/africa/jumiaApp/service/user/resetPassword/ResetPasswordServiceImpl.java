...
public class ResetPasswordServiceImpl implements ResetPasswordService{
    ...
    @Override
    public String emailOtp(SendOTPRequest sendOTPRequest) {

        boolean isExists = userService.findUserByEmailAddress(sendOTPRequest.getEmailAddress()).isPresent();
        if (!isExists)throw new GenericHandlerException("user not found");
        String generateOtp = OTPGenerator.generateOtp().toString();
        ...
        return "OTP Successfully sent to your mail";
    }
